...
!!! tip "Workspace auto-created?"
    If you set `CREATE_FABRIC_WORKSPACE=true` before running `azd up` (see [Fabric Setup ΓåÆ Path A](02-setup-fabric.md#path-a--auto-provision-everything-recommended)), you can **skip this section entirely** ΓÇö the build script creates the workspace and discovers its ID automatically. Jump to [Build solution](04-run-scenario.md) and omit `--fabric-workspace-id` when you run it.

### Get Your Workspace ID

1. Go to [Microsoft Fabric](https://app.fabric.microsoft.com/)
2. Open your workspace
3. Note the workspace ID from the URL ΓÇö you'll pass it as a parameter in the next step:
...
[ΓåÉ Fabric Setup](02-setup-fabric.md) | [Build solution ΓåÆ](04-run-scenario.md)
