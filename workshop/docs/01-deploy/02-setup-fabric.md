...
!!! tip "Auto-create with `azd up`"
    You can automate Fabric capacity and workspace creation. Set this flag **before `azd up`**:

    ```bash
    azd env set CREATE_FABRIC_WORKSPACE true
    ```

    If you use this option, you can skip Steps 1–2 and go directly to [Step 3](#step-3-verify-workspace-settings).
